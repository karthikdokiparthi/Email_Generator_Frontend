  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black to-blue-900 py-5 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className=" border-white border-2 rounded-2xl shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            {/* Form Section */}
            <div className="p-6 md:p-8 border-r border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-100">Compose Email</h2>
                <button
                  onClick={clearForm}
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    rows={6}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg text-white bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                    ...
                    {[
                      ...
                      <label
                        ...
                        className={`flex items-center justify-center cursor-pointer p-3 rounded-lg border transition-all ${user.tone === tone.value
                          ...
                          : 'border-gray-200 hover:border-indigo-400 text-gray-100'
                          }`}
                      >
                        <input
                          type="radio"
            ...
            <div className=" p-6 md:p-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-100">Generated Email</h2>
                <button
              ...
              {error ? (
                <div className="bg-gray-900 border-l-4 border-red-500 text-red-700 p-4 rounded-lg">
                  <p className="font-medium">Error</p>
                  <p>{error}</p>
                </div>
              ) : generatedReply ? (
                <div className="bg-gray-900 border border-white p-5 rounded-lg shadow-inner min-h-[250px]">
                  <div className="whitespace-pre-wrap text-gray-100">
                    {generatedReply}
                  </div>
                </div>
              ) : loading ? (
                <div className="flex items-center justify-center min-h-[250px] bg-gray-900 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-100 font-medium">Generating your response...</p>
                  </div>
                </div>
              ) : (
                <div className="flex flex-col items-center justify-center min-h-[250px] bg-gray-900 rounded-lg p-6 text-center">
                  <div className="bg-indigo-100 p-4 rounded-full mb-5">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <h3 className="text-lg font-bold text-gray-100 mb-2">Your Generated Email</h3>
        ...
        {error && (
          <div className="mt-6 p-4 bg-gray-900 text-red-700 rounded-lg border border-red-500">
            Error: {error}
          </div>
        )}
